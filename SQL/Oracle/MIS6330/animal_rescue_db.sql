...
GRANT SELECT ON RMOORE.AnimalVaccinations TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Vaccinations TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Adoptions TO INSTRUCTOR;
GRANT SELECT ON RMOORE.AdoptablePets TO INSTRUCTOR;
GRANT SELECT ON RMOORE.PetStatus TO INSTRUCTOR;
GRANT SELECT ON RMOORE.StaffAtLocation TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Locations TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Adopters TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Staff TO INSTRUCTOR;
GRANT SELECT ON RMOORE.Breeds TO INSTRUCTOR;
GRANT SELECT ON RMOORE.TypeOfAnimals TO INSTRUCTOR;
