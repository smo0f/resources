/* MIS6330 Lab 16 - Machine Learning */

--Problem 1
--First run the prep script.
--Then, step through the following statements as an example of an xgboost model.

--Turn in a screenshot of the last query, the AUC results.
